...
status_label = ttk.Label(footer_frame, text="Bereit, lade eine Home Assistant Entitäten CSV-Datei.", relief=tk.SUNKEN, anchor=tk.W, background='#d8d8d8', foreground='#333333')
status_label.pack(side=tk.LEFT, fill=tk.BOTH, expand=True)

# Version/Copyright-Label auf der rechten Seite
version_label = ttk.Label(footer_frame, text=" v1 by jayjojayson", relief=tk.SUNKEN, anchor=tk.E, background='#d8d8d8', foreground='#333333')
